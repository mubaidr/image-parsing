module.exports = /******/ (function (modules) {
  ...
  /******/ /******/ return __webpack_require__(
    (__webpack_require__.s = './@/utilities/workers/extract.worker.ts'),
  )
  /******/
})(
  /************************************************************************/
...
***************************************************************************** */
  ...
  \**************************************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        const excel_1 = __webpack_require__(
          /*! ../excel */ './@/utilities/excel.ts',
        )
        const Result_1 = tslib_1.__importDefault(
          __webpack_require__(
            /*! ./Result */ './@/utilities/@classes/Result.ts',
          ),
        )
        class CompiledResult {
          ...
          sortResults() {
            this.results.sort((a, b) => {
              return (
                parseInt(a.rollNo || '0', 10) - parseInt(b.rollNo || '0', 10)
              )
            })
            return this
          }
          getRandomResults(percent) {
            ...
            const count = Math.max(
              Math.floor(((percent || 5) * resultCount) / 100),
              1,
            )
            const ids = []
            const results = []
  ...
  \******************************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        const uuid_1 = __webpack_require__(/*! uuid */ 'uuid')
        const QuestionOptionsEnum_1 = tslib_1.__importDefault(
          __webpack_require__(
            /*! ../@enums/QuestionOptionsEnum */ './@/utilities/@enums/QuestionOptionsEnum.ts',
          ),
        )
        const RegExpPatterns_1 = tslib_1.__importDefault(
          __webpack_require__(
            /*! ../@enums/RegExpPatterns */ './@/utilities/@enums/RegExpPatterns.ts',
          ),
        )
        class Result {
          ...
          compile(key, marks, negativeMarks) {
            ...
            for (let k = 0; k < props.length; k += 1) {
              ...
              if (
                candidateChoice.value === QuestionOptionsEnum_1.default.NONE
              ) {
              ...
              // question skipped
              if (
                keyChoice.value === QuestionOptionsEnum_1.default.NONE ||
          ...
          isKey() {
            return (
              ...
              this.rollNo.trim().toLowerCase() === 'key'
            )
          }
          isResult() {
            return !this.isKey()
          ...
          setMarks(marks, negativeMarks) {
            this.marks =
              this.correctCount * marks - this.incorrectCount * negativeMarks
  ...
  \*************************************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        const design_1 = __webpack_require__(
          /*! ../design */ './@/utilities/design.ts',
        )
        const images_1 = __webpack_require__(
          /*! ../images */ './@/utilities/images.ts',
        )
        const readKey_1 = __webpack_require__(
          /*! ../readKey */ './@/utilities/readKey.ts',
        )
        const CompiledResult_1 = tslib_1.__importDefault(
          __webpack_require__(
            /*! ./CompiledResult */ './@/utilities/@classes/CompiledResult.ts',
          ),
        )
        ...
        ;(function (PROGRESS_STATES) {
          ...
          PROGRESS_STATES['COMPLETE'] = 'completed'
          PROGRESS_STATES['ERROR'] = 'error'
          PROGRESS_STATES['LOG'] = 'log'
          PROGRESS_STATES['EXIT'] = 'exit'
          PROGRESS_STATES['DATA'] = 'data'
        })(
          (PROGRESS_STATES =
            exports.PROGRESS_STATES || (exports.PROGRESS_STATES = {})),
        )
        var WORKER_TYPES
        ...
        class WorkerManager extends events_1.EventEmitter {
          ...
          createWorkers(count, type) {
            for (let i = 0; i < count; i += 1) {
              const worker = child_process_1.fork(
                `./dist-electron/workers/${type}.worker.js`,
              )
              ...
              if (worker.stdout) {
                worker.stdout.on(PROGRESS_STATES.DATA, (data) => {
          ...
          async extract(directory, designId) {
            const [designData, totalImages] = await Promise.all([
              design_1.getDesignData(designId),
              images_1.getImagePaths(directory),
            ])
          ...
          async compile(resultPath, keyPath, correctMarks, incorrectMarks) {
            const results = CompiledResult_1.default
              .loadFromExcel(resultPath)
              .getResults()
            const keys = await readKey_1.readKey(keyPath)
            ...
            for (let i = 0; i < totalWorkers; i += 1) {
              const startIndex = i * step
              const endIndex =
                i === totalWorkers - 1 ? results.length : (i + 1) * step
              this.workers[i].send({
  ...
  \***********************************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        Object.defineProperty(exports, '__esModule', { value: true })
        var KeyNativeEnum
        ;(function (KeyNativeEnum) {
          KeyNativeEnum['csv'] = 'csv'
          KeyNativeEnum['xls'] = 'xls'
          KeyNativeEnum['xlsm'] = 'xlsm'
          KeyNativeEnum['xlsx'] = 'xlsx'
        })(KeyNativeEnum || (KeyNativeEnum = {}))
        exports.default = KeyNativeEnum
  ...
  \********************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        const Cache_1 = tslib_1.__importDefault(
          __webpack_require__(
            /*! ./@classes/Cache */ './@/utilities/@classes/Cache.ts',
          ),
        )
  ...
  \********************************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        function convertToBitArray(data, channels) {
          const binaryData = []
          for (
            let i = 0, dataLength = data.length;
            i < dataLength;
            i += channels
          ) {
            const threshold = 15
  ...
  \************************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        const os_1 = tslib_1.__importDefault(
          __webpack_require__(/*! os */ 'os'),
        )
        const path_1 = tslib_1.__importDefault(
          __webpack_require__(/*! path */ 'path'),
        )
        const isDev = 'development' === 'development'
        const tmp = isDev
          ? path_1.default.resolve('.tmp')
          : os_1.default.tmpdir()
        ...
        const dataPaths = {
          ...
          imagesBarcode: path_1.default.resolve(
            'tests',
            '_data',
            'images-barcode',
          ),
          ...
          resultCompiled: path_1.default.resolve(
            'tests',
            '_data',
            'resultCompiled.xlsx',
          ),
  ...
  \*********************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        const fast_xml_parser_1 = __webpack_require__(
        ...
        const dataPaths_1 = __webpack_require__(
          /*! ./dataPaths */ './@/utilities/dataPaths.ts',
        )
        ...
        async function getDesignData(id) {
          ...
          const { svg } = fast_xml_parser_1.parse(
          ...
          const PATTERN_OPTION = new RegExp(
            RegExpPatterns_1.default.OPTION,
            'i',
          )
          const PATTERN_BARCODE = new RegExp(
            RegExpPatterns_1.default.BARCODE,
            'i',
          )
          const PATTERN_QRCODE = new RegExp(
            RegExpPatterns_1.default.QRCODE,
            'i',
          )
          // for export
          ...
          svg.g.forEach((group) => {
            ...
            if (PATTERN_OPTION.test(title)) {
              ...
              PATTERN_BARCODE.test(title) ||
              PATTERN_QRCODE.test(title)
            ) {
  ...
  \********************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        const xlsx_1 = tslib_1.__importDefault(
          __webpack_require__(/*! xlsx */ 'xlsx'),
        )
        const CompiledResult_1 = tslib_1.__importDefault(
          __webpack_require__(
            /*! ./@classes/CompiledResult */ './@/utilities/@classes/CompiledResult.ts',
          ),
        )
        const string_1 = __webpack_require__(
        ...
        const importExcelToJson = (src) => {
          ...
          Object.values(workbook.Sheets).forEach((sheet) => {
            ...
            for (let i = 0, rowsLength = rows.length; i < rowsLength; i += 1) {
              ...
              for (
                let j = 0, keysLength = keys.length;
                j < keysLength;
                j += 1
              ) {
                const key = keys[j]
        ...
        function exportJsonToExcel(compiledResult, destination) {
          ...
          const rows =
            compiledResult instanceof CompiledResult_1.default
  ...
  \*********************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        const fast_glob_1 = tslib_1.__importDefault(
          __webpack_require__(/*! fast-glob */ 'fast-glob'),
        )
        const path_1 = tslib_1.__importDefault(
          __webpack_require__(/*! path */ 'path'),
        )
        const sharp_1 = tslib_1.__importDefault(
          __webpack_require__(/*! sharp */ 'sharp'),
        )
        const uuid_1 = __webpack_require__(/*! uuid */ 'uuid')
        const ImageNativeTypesEnum_1 = tslib_1.__importDefault(
          __webpack_require__(
            /*! ./@enums/ImageNativeTypesEnum */ './@/utilities/@enums/ImageNativeTypesEnum.ts',
          ),
        )
        const ImageTypesEnum_1 = tslib_1.__importDefault(
          __webpack_require__(
            /*! ./@enums/ImageTypesEnum */ './@/utilities/@enums/ImageTypesEnum.ts',
          ),
        )
        ...
        const convertImage = async (src) => {
          ...
          const url = path_1.default.join(
            dataPaths_1.dataPaths.tmp,
            `${uuid_1.v4()}.jpg`,
          )
        ...
        const logImageData = async (src, name) => {
          let img
          const target = path_1.default.join(
            dataPaths_1.dataPaths.tmp,
            `${name || uuid_1.v4()}.jpg`,
          )
  ...
  \************************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        const convertToBitArray_1 = __webpack_require__(
          /*! ./convertToBitArray */ './@/utilities/convertToBitArray.ts',
        )
        const getQuestionsData = async (design, img, compiledResult) => {
          ...
          for (
            ...
            const { data, info } = await img.toBuffer({
              resolveWithObject: true,
            })
            // console.log(info)
            const bitData = convertToBitArray_1.convertToBitArray(
            ...
            if (compiledResult) {
              ...
              if (
                result[titleLowerCase].value !==
                QuestionOptionsEnum_1.default.MULTIPLE
              ) {
  ...
  \**********************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        const Result_1 = tslib_1.__importDefault(
          __webpack_require__(
            /*! ./@classes/Result */ './@/utilities/@classes/Result.ts',
          ),
        )
        const KeyNativeEnum_1 = tslib_1.__importDefault(
          __webpack_require__(
            /*! ./@enums/KeyNativeEnum */ './@/utilities/@enums/KeyNativeEnum.ts',
          ),
        )
        const dataPaths_1 = __webpack_require__(
          /*! ./dataPaths */ './@/utilities/dataPaths.ts',
        ...
        const extractTask = tslib_1.__importStar(
          __webpack_require__(
            /*! ./workers/extract.worker */ './@/utilities/workers/extract.worker.ts',
          ),
        )
        async function readKey(src) {
          const ext = src.split('.').pop()
          if (ext === undefined) throw new Error('Invalid path specified')
          if (ext in KeyNativeEnum_1.default) {
            const rows = excel_1.importExcelToJson(src)
            const results = []
            for (let i = 0, len = rows.length; i < len; i += 1) {
              results.push(Result_1.default.fromJson(rows[i]))
            }
            return results
          }
          const designData = await design_1.getDesignData(
            dataPaths_1.dataPaths.designBarcode,
          )
  ...
  \*************************************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        const WorkerManager_1 = __webpack_require__(
          /*! ../@classes/WorkerManager */ './@/utilities/@classes/WorkerManager.ts',
        )
        const images_1 = __webpack_require__(
          /*! ../images */ './@/utilities/images.ts',
        )
        const questions_1 = __webpack_require__(
          /*! ../questions */ './@/utilities/questions.ts',
        )
        const sheetInfo_1 = __webpack_require__(
          /*! ../sheetInfo */ './@/utilities/sheetInfo.ts',
        )
        ...
        async function start(message, isWorker = true) {
          ...
          if (isWorker) {
            sendMessage({
              progressState: WorkerManager_1.PROGRESS_STATES.COMPLETE,
              payload: results,
            })
            process.exit(0)
          } else {
